...
food = input("What a type of food you want? ")
plant = input("What type of plant you like? ")
cooking = input("What method of cooking you do? ")
bfood = input("word to descrbe burned food ")
hhold = input("what household item you want? ")
print(cooking, food, "with", bfood, plant, "on a bed of ", hhold)
